                    ...
                    <form class="form" method="post" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">
                                <i class="fa fa-sharp fa-solid fa-user-bounty-hunter"></i>
                            </label>
                        ...
                        <div class="form-group row">
                            <label for="surname" class="col-md-4 col-form-label text-md-right"><i class="fa fa-sharp fa-solid fa-user-bounty-hunter"></i></label>
                        ...
                        <div class="form-group row">
                            <label for="form" class="col-md-4 col-form-label text-md-right">
                                {{ __('Cicle') }}
                            </label>
